...
createCSSRule('.enter-AR-button', "position: absolute; display: block; z-index: 1; background-color: rgba(255,255,255,0); width: 200; bottom: 20px; height: 50px; left: 50%; margin-left: -100px; background-size: 100%; cursor: pointer; outline: 0;", false, '');
...
setHTMLElemAttribute('src', 'media/enter_AR_button', 'enter_AR_img', false);
createCSSRule('.enter-AR-button', "position: absolute; width: 100%; height: 50px; top: 50%; margin-top: -25%; left: 0; display: none;", false, '');
addHTMLElement('div', 'warning_center', 'TO', ['CONTAINER'], false);
setHTMLElemAttribute('src', 'warning-center', 'warning_center', false);
...
setHTMLElemAttribute('src', '.warning-AR-unavailable', 'warning_AR_unavailable', false);
addHTMLElement('img', 'warning_AR_unavailable_img', 'TO', 'warning_AR_unavailable', false);
setHTMLElemAttribute('src', 'media/warning_AR_unavailable', 'warning_AR_unavailable_img', false);
createCSSRule('.warning-could-not-enter-AR', "position: absolute; width: 242px; height: 50px; left: 50%; margin-left: -121px; display: none;", false, '');
addHTMLElement('div', 'warning_could_not_enter_AR', 'TO', 'warning_center', false);
setHTMLElemAttribute('src', 'media/warning_could_not_enter_AR', 'warning_could_not_enter_AR', false);
addHTMLElement('img', 'warning_could_not_enter_AR', 'TO', 'warning_could_not_enter_AR', false);
setHTMLElemAttribute('src', 'media/warning_could_not_enter_AR', 'warning_AR_unavailable_img', false);
createCSSRule('.infobutton', "position: absolute; width: 50px; height: 50px; z-index: auto; top: auto; right: auto; background-repeat: no-repeat; display: block; overflow: hidden; border-style: none; border-color: #000000; cursor: pointer;", false, '');
addHTMLElement('a', 'info_button', 'TO', ['CONTAINER'], false);
setHTMLElemAttribute('className', 'info-button', 'info_button', false);
setHTMLElemAttribute('href', 'https://gauri.com', 'info_button', false);
...
operateAnimation('PLAY', 'gauri_armature', 0, 190, 'AUTO', 1, function() {}, false);

volume(loadMedia_WebAudio('sounds/Hello.mp3'), 0.5);
registerOnClick('gauri_mesh', false, false, [0,1,2], false, function(event) {
    operateAnimation('STOP', 'gauri_armature', null, null, 'AUTO', 1, function() {}, false);
    playSound(loadMedia_WebAudio('sounds/Hello.mp3'), false);
    operateAnimation('PLAY', 'gauri_armature', 191, 121, 'AUTO', 1, function() {
        operateAnimation('PLAY', 'gauri_armature', 0, 190, 'AUTO', 1, function() {}, false);
    }, false);
}, function(event) {});
...
checkARMode(function() {
    eventHTMLElem('pointerup', 'enter_AR_button', false, function(event) {
        enterARMode('ORIGIN', true, function() {
            changeVis(['GROUP', 'gauri_group'], false);
            ...
            setObjTransform('gauri_armature', false, 'position', [1, 1, 1], false);
            updateTextObj('scale_percentage', '100%');
        }, function() {
            changeVis(['GROUP', 'gauri_group'], true);
            changeVis('prompt_move_around', false);
            setObjTransform('gauri_armature', false, 'position', createVector(0, 0, 0), false);
    ...
    setHTMLElemAttribute('href', exportToUSDZ('gauri_mesh'), 'enter_AR_button', false);
    setHTMLElemAttribute('rel', 'ar', 'enter_AR_button', false);
    setHTMLElemAttribute('download', 'gauri.usdz', 'enter_AR_button', false);
}, function() {
    eventHTMLElem('pointerup', 'enter_AR_button', false, function(event) {
...
registerOnClick('indicator_invis_plane', false, false, [0,1,2], false, function(event) {
    changeVis(['GROUP', 'gauri_group'], true);
    setObjTransform('gauri_armature', false, 'position', [arHitPoint('x'), arHitPoint('y'), arHitPoint('z')], false);
    setObjDirection('gauri_armature', getObjTransform('Camera', false, 'position', 'xyz'), true, true);
...
registerOnDrag('drag_move', false, [0,1,2], function(event) {}, function(event) {
    dragMoveAdv('gauri_armature', 'XY', 'WORLD', 'yf2w3g_YH-,9nnx]ujRQ', 'Vkar-_@I^Rc3#[nCnoxE');
}, function(event) {}, 'Vkar-_@I^Rc3#[nCnoxE');

registerOnDrag('drag_rotate', false, [0,1,2], function(event) {}, function(event) {
    dragRotateAdv('gauri_armature', 'Z', 'WORLD', 'Sz%iDj=O@EK|py7pxsi?', '|p9p!AYEF8%u@[@55rAg');
}, function(event) {}, '|p9p!AYEF8%u@[@55rAg');

registerOnDrag('drag_scale', false, [0,1,2], function(event) {}, function(event) {
    dragScale('gauri_armature', 'Z', 'l0/w/0?!(eam63Ql)9kt', '+0byzddai[J#tm}![ax)');
    dragScale('gauri_armature', 'X', '@8jx0[]_?6T8VzRWhvZK', '+0byzddai[J#tm}![ax)');
    dragScale('gauri_armature', 'Y', 'l/Y35t#W|1F/4K5^7Mi6', '+0byzddai[J#tm}![ax)');
    updateTextObj('scale_percentage', String(Math.round(toFixedPoint(getObjTransform('gauri_armature', false, 'scale', 'z'), 2) * 100)) + '%');
}, function(event) {}, '+0byzddai[J#tm}![ax)');
